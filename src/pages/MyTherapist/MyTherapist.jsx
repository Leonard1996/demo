...
export const MyTherapist = () => {
  ...
  const { details: { type, cover_letter } = {} } = data
          ...
          <Row>
            ...
            <Col style={{ textAlign: 'start', marginLeft: '50px' }}>
              <Space size={10} direction="vertical">
                ...
                <div className="type">Approccio {type ?? 'cognitivo-comportamentale'}</div>
                <Divider style={{ margin: '10px 0' }} />
                <Space size={2} direction="vertical">
                  <div className="experiences">Specializzazioni:</div>
                  {['1. Example skill 1', '2. Example skill 2'].map(d =><div key={d}>{d}</div>)}
                </Space>
                <Divider style={{ margin: '10px 0' }} />
